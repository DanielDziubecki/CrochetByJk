...
const AskForProduct = React.createClass({
    getInitialState() {
        return {show: false, productName: this.props.productName};
    },
    render() {
        return (
                    ...
                    <Modal
                        ...
                        <Modal.Header closeButton>
                            <Modal.Title id="contained-modal-title">
                                <b>Pytanie o produkt: {this.props.productName}</b>
                            </Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                            <Form id="productQuestionForm">
                                <FormGroup controlId="emailAdress" htmlFor="email">
                                ...
                                <FormGroup controlId="productQuestion" htmlFor="question">
                                    <Col componentClass={ControlLabel}>
                                        Treść</Col>
                                    <Col>
                                        <FormControl
                                ...
                                <FormGroup controlId="newsLetter">
                                    <Col>
                                        <Checkbox id="addToNewsletter" defaultChecked inline>
                                            <Col componentClass={ControlLabel}>
                                                Chcę otrzymywać powiadomienia o nowych produktach.</Col>
                                        </Checkbox>
                                    </Col>
                                </FormGroup>
                                <Button
    ...
    toggleModal: function () {
        var seeAlso = $("#seeAlsoContainer");
        var footer = $("#footer");
        if (this.state.show) {
            seeAlso.css('opacity', 1)
            footer.css('opacity', 1)
        } else {
            seeAlso.css('opacity', 0.1)
